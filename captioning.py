...
def main(args):
    ...
    if use_dual:
        # ==================== 双流模式 ====================
        from dataset_dual import SoccerNetCaptionsDual, collate_fn_gpt_dual, collate_fn_padd_dual
        from dual_qformer import DualVideo2Caption
        ...
        model = DualVideo2Caption(
            ...
            top_k=args.top_k,
            gpt_dropout=getattr(args, "gpt_dropout", 0.1),
            encoder_dropout=getattr(args, "encoder_dropout", 0.1),
        ).cuda()

        collate_fn = collate_fn_gpt_dual
    ...
    if not args.test_only:
        ...
        trainer("caption", train_loader, val_loader, val_metric_loader, 
                ...
                max_epochs=_epochs_caption, evaluation_frequency=args.evaluation_frequency)
