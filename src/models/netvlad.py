...
class QFormerVideoPooling(nn.Module):
    def __init__(self, input_dim, output_dim, num_heads=8, num_layers=4, dropout=0.0, num_tokens = 8):
        ...
        self.tranformer_decoder = nn.TransformerDecoder(nn.TransformerDecoderLayer(d_model=input_dim, nhead=num_heads, dropout=dropout, batch_first=True), num_layers=num_layers)
